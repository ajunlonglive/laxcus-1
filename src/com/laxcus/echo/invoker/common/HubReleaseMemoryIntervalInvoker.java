 ...
 * @since laxcus 1.0
 */
public abstract class HubReleaseMemoryIntervalInvoker extends CommonReleaseMemoryIntervalInvoker {
	 ...
	 */
	protected HubReleaseMemoryIntervalInvoker(ReleaseMemoryInterval cmd) {
		super(cmd);
	}
...
//	 * @return
//	 */
//	private ReleaseMemoryInterval createSubCommand() {
//		ReleaseMemoryInterval cmd = getCommand();
//		ReleaseMemoryInterval sub = new ReleaseMemoryInterval();
...
//					ReleaseMemoryInterval sub = createSubCommand();
...
//	}
	...
	/*
	 * (non-Javadoc)
	 * @see com.laxcus.echo.invoke.common.HubReleaseMemoryIntervalInvoker#launch()
	 */
	@Override
	...
	public boolean ending() {
		...
		for (int index : keys) {
			if (!isSuccessObjectable(index)) {
				...
				Logger.error(this, "ending", "fault node:%s", node);
...
//			ReleaseMemoryInterval cmd = (ReleaseMemoryInterval) e.getCommand();
//			cmd.add(job);
//		}
//		// 4. 以上空时，把生成单元保存到输出数据
//		if (empty) {
...
//	 * @return 返回真或者假
//	 */
//	protected abstract boolean isSlaveSite(byte family);
}