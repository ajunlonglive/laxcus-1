...
/**
 * 工作类站点的释放节点内存间隔命令调用器 <br>
 * 
 * @author scott.liang
 * @version 1.0 12/07/2018
 * @since laxcus 1.0
 */
public class SubReleaseMemoryIntervalInvoker extends CommonReleaseMemoryIntervalInvoker {

	/**
	 * 构造释放节点内存间隔命令调用器，指定命令
	 * @param cmd 释放节点内存间隔命令
	 */
	public SubReleaseMemoryIntervalInvoker(ReleaseMemoryInterval cmd) {
		super(cmd);
	}
