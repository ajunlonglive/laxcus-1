 ...
 * @since laxcus 1.0
 */
public abstract class RayDisplayInvoker extends EchoInvoker {
	...
	public static void setDefaultDisplay(MeetDisplay e) {
		RayDisplayInvoker.defaultDisplay = e;
	}
	...
	public static MeetDisplay getDefaultDisplay() {
		return RayDisplayInvoker.defaultDisplay;
	}
	...
	public static ProductListener getDefaultProductListener() {
		if (RayDisplayInvoker.defaultDisplay != null) {
			return RayDisplayInvoker.defaultDisplay.getProductListener();
		}
		return null;
	}
	 ...
	 * @param cmd 命令
	 */
	protected RayDisplayInvoker(Command cmd) {
		super(cmd);
	}
