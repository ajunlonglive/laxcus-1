 ...
 * @since laxcus 1.0
 */
public class RayOutlookIntervalInvoker extends RayInvoker {

	/**
	 * 构造被WATCH监视节点的定时刷新调用器，指定命令
	 * @param cmd 被WATCH监视节点的定时刷新命令
	 */
	public RayOutlookIntervalInvoker(OutlookInterval cmd) {
		super(cmd);
	}
	...
	public boolean launch() {
		...
		// 更新超时时间
		RayTube.setTimeout(cmd.getInterval());

		print(RayTube.getTimeout());
