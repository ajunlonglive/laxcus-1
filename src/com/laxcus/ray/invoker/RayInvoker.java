 ...
 * @since laxcus 1.0
 */
public abstract class RayInvoker extends RayDisplayInvoker {

	/** RayInvoker调用器界面配置加载器 **/
	...
	private static void loadInvokerSurface() {
		LocalSelector selector = new LocalSelector("conf/ray/invoker/config.xml");
...
//	private MeetDisplay display;
	 ...
	 * @param cmd 异步命令
	 */
	protected RayInvoker(Command cmd) {
		super();
		// 流式处理或者否，由WATCH管理员决定。
...
//	 */
//	@Override
//	public RayLauncher getLauncher() {
//		return (RayLauncher) super.getLauncher();
//	}
//
//	/*
//	 * (non-Javadoc)
...
//		return (RayCommandPool) super.getCommandPool();
//	}
//
//	/*
//	 * (non-Javadoc)
...
//		return (RayInvokerPool) super.getInvokerPool();
//	}
...
//	Invoker.SuccessIcon [ICON 16*16] conf/desktop/image/invoker/success.png
//	Invoker.FailedIcon [ICON 16*16] conf/desktop/image/invoker/failed.png
...
//	/**
//	 * 返回混合面板
//	 * @return RayMixedPanel实例
//	 */
//	protected RayMixedPanel getDisplayPanel() {
//		RayLauncher launcher = getLauncher();
...
//		RayMixedPanel display = getDisplayPanel();
...
//			cell.setBackground(background);
	...
	protected void printSubGap(int columns) {
		Color foreground = null; 
		Color background = findXMLBackground("SUBGAP/ITEM", new Color(0xd5e5e9));
