 ...
 * @since laxcus 1.0
 */
public final class RayFrontMemo implements Classable, Cloneable, Serializable , Comparable<RayFrontMemo> {
	 ...
	 */
	private RayFrontMemo(RayFrontMemo that) {
		super();
		siger = that.siger;
	 ...
	 * @param siger 账号签名
	 */
	public RayFrontMemo(Siger siger) {
		this();
		setSiger(siger);
	}
	 ...
	 * @since 1.1
	 */
	public RayFrontMemo(ClassReader reader) {
		this();
		resolve(reader);
	}
	 ...
	 * @return 加入成功返回真，否则假
	 */
	public boolean accede(RayFrontMemo that) {
	 ...
	 */
	public RayFrontMemo duplicate() {
		return new RayFrontMemo(this);
	}
	 ...
	 */
	@Override
	public int compareTo(RayFrontMemo that) {
		if (that == null) {
			return 1;
		}
