...
class FrameButton extends CraftButton {
	...
	void initPopupMenu() {
		...
		//		JMenuItem recover = createMenuItem("StatusBar.FrameButton.PopupMenu.RestoreIcon","StatusBar.FrameButton.PopupMenu.RestoreText", "StatusBar.FrameButton.PopupMenu.RestoreMWord", "StatusBar.FrameButton.PopupMenu.RestoreMethod");
		//		JMenuItem mini = createMenuItem("StatusBar.FrameButton.PopupMenu.MiniIcon", "StatusBar.FrameButton.PopupMenu.MiniText", "StatusBar.FrameButton.PopupMenu.MiniMWord", "StatusBar.FrameButton.PopupMenu.MiniMethod");
		//		JMenuItem max = createMenuItem("StatusBar.FrameButton.PopupMenu.MaxIcon","StatusBar.FrameButton.PopupMenu.MaxText", "StatusBar.FrameButton.PopupMenu.MaxMWord", "StatusBar.FrameButton.PopupMenu.MaxMethod");
		//		JMenuItem close = createMenuItem("StatusBar.FrameButton.PopupMenu.CloseIcon","StatusBar.FrameButton.PopupMenu.CloseText", "StatusBar.FrameButton.PopupMenu.CloseMWord", "StatusBar.FrameButton.PopupMenu.CloseMethod");
	...
	private void showSnapshotWindow() {
		...
		Image image = null;
		if (SnapshotWindowModel.isZoom(snapshotMode)) {
			image = RayUtil.shotZoomImage(frame, width, height, 2);
			snapshotWindow.setPaintBorder(true);
		} else if (SnapshotWindowModel.isFill(snapshotMode)) {
			image = RayUtil.shotFillImage(frame, width, height, 0);
