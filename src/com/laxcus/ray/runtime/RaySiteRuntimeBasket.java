 ...
 * @since laxcus 1.0
 */
public class RaySiteRuntimeBasket extends MutexHandler {

	/** WATCH节点运行时容器 **/
	private static RaySiteRuntimeBasket selfHandle = new RaySiteRuntimeBasket();
	 ...
	 */
	public static RaySiteRuntimeBasket getInstance() {
		return RaySiteRuntimeBasket.selfHandle;
	}
