...
final class WallPaperLoader {
	...
	private boolean setWallPaper(File file, int layout)  {
		...
		// 设置桌面壁纸
		DesktopWall wall = new DesktopWall(null, img, layout); // DesktopWall.FULL);
	...
	private void setReadFile(File file, int layout) {
		...
		RTKit.writeInteger(RTEnvironment.ENVIRONMENT_SYSTEM, "RayWindow/Background/Layout", layout);
	}
