 ...
 */
package com.laxcus.ray.frame.help;
 ...
 * @since laxcus 1.0
 */
public class RayHelpFrame extends RayFrame {

	private static final long serialVersionUID = 5666302250621358120L;
	
	/** 句柄 **/
	static RayHelpFrame selfHandle;

	/**
	 * 返回句柄
	 * @return
	 */
	public static RayHelpFrame getInstance() {
		return RayHelpFrame.selfHandle;
	}
...
//		setFrameIcon(findImage("conf/ray/image/frame/help.png", 16, 16)); 
