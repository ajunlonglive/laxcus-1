 ...
 * @since laxcus 1.0
 */
public class RayDesktopManager extends DefaultDesktopManager implements UIResource {

	private static final long serialVersionUID = -7546784251682504006L;

	/** FRONT桌面 **/
	private RayDesktop desktop;

	/**
	 * 构造FRONT桌面管理器
	 * @param desktop FRONT桌面
	 */
	public RayDesktopManager(RayDesktop desktop) {
		super();
	 ...
	 * @param d
	 */
	public void setFrontDesktop(RayDesktop d) {
		desktop = d;
	}
	 ...
	 * @return
	 */
	public RayDesktop getFrontDesktop() {
		return desktop;
	}
