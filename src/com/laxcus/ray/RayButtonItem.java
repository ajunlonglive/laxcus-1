 ...
 * @since laxcus 1.0
 */
final class RayButtonItem extends WProgram { 
	...
	/** 按纽位置 **/
	private RayContour rayContour;

	/**
	 * 构造默认的按纽单元
	 */
	public RayButtonItem() {
		super();
		// 建立时间
	 ...
	 * @param that 按纽单元
	 */
	private RayButtonItem(RayButtonItem that) {
		super(that);
	 ...
	 * @param w
	 */
	public RayButtonItem(WProgram w) {
		super(w);
		createTime = System.currentTimeMillis();
	}
	 ...
	 * @param reader 可类化读取器
	 */
	public RayButtonItem(ClassReader reader) {
		this();
		resolve(reader);
	}
...
//	}
	...
	public void setContour(RayContour e) {
		rayContour = e;
	}
	
	public RayContour getContour(){
		return rayContour;
	}
	 ...
	 */
	@Override
	public RayButtonItem duplicate(){
		return new RayButtonItem(this);
	}
	...
	protected void resolveSuffix(ClassReader reader) {
		...
		rayContour = new RayContour(reader);
	}
