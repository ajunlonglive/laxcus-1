 ...
 * @since laxcus 1.0
 */
public class RayLaunchMenu extends JPopupMenu implements LaunchMenu {
...
//			if (theme != null) {
//				ColorUIResource c = theme.getPrimaryControl(); // getPrimary3颜色
//
//				Color c1 = toDrak(c, 68);
//				Color c2 = toLight(c, 20);
//
//				dark = new ESL(c1);
//				light = new ESL(c2);
//			}
...
//	}
	...
	private Color[] createDarkLights() {
		// 淡白
		if (Skins.isMetal() && Skins.isGraySkin()) {
			MetalTheme theme = MetalLookAndFeel.getCurrentTheme();
			if (theme != null) {
				ColorUIResource c = theme.getPrimaryControl(); // getPrimary3颜色
				Color c1 = toDrak(c, 68);
