 ...
 * @since laxcus 1.0
 */
class InstallTableDeployDockIconCellRenderer extends DefaultTableCellRenderer {
	...
	public InstallTableDeployDockIconCellRenderer() {
		super();
		init();
	}
	...
	private void loadText() {
		yesText = UIManager.getString("InstallDialog.yesDeployDockIconText");
		if (yesText == null) {
			yesText = "Yes";
		}
		noText = UIManager.getString("InstallDialog.noDeployDockIconText");
		if (noText == null) {
			noText = "No";
		}
	}
