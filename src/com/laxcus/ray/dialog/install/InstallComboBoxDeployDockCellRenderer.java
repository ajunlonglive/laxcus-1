...
* @since laxcus 1.0
*/
class InstallComboBoxDeployDockCellRenderer extends JLabel implements ListCellRenderer { 
	 ...
	 * 分布站点参数
	 */
	public InstallComboBoxDeployDockCellRenderer() {
		super();
		init();
	}
	...
	public Component getListCellRendererComponent(JList list, Object value,
		...
		// 传入对象是String
		if (value.getClass() != InstallDockIcon.class) {
			setIcon(null);
			setText("");
			return this;
		}
		...
		// 部署图标到桌面
		InstallDockIcon node = (InstallDockIcon) value;
		// 文本
