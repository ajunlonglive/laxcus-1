 ...
 * @since laxcus 1.0
 */
class NotifyTableModel extends DefaultTableModel {

	private static final long serialVersionUID = -4085519356367050753L;
	 ...
	 * @return
	 */
	public ShowItem getRow(int index) {
		if (index >= 0 && index < array.size()) {
