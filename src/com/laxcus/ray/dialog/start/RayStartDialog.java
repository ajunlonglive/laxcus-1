 ...
 */
package com.laxcus.ray.dialog.start;
 ...
 * @since laxcus 1.0
 */
public class RayStartDialog extends LightDialog implements ActionListener {
	 ...
	 * 构造启动窗口
	 */
	public RayStartDialog(StartKey e, String link) {
		super();
		startKey = e;
		// 转义目录
		pickup(link);
