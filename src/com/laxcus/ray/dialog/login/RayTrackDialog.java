 ...
 * @since laxcus 1.0
 */
public class RayTrackDialog extends JDialog implements RayLoginTracker, Runnable {
	 ...
	 * @param modal
	 */
	public RayTrackDialog(JDialog owner, boolean modal) {
		super(owner, modal);
...
//		icon = loader.findImage("conf/ray/image/login/ball.png");
	}
