 ...
 */
package com.laxcus.ray.dialog.shutdown;
 ...
 * @since laxcus 1.0
 */
public class RayShutdownDialog extends RayLightDialog implements ActionListener {
...
//	if (theme != null) {
//		Color c = theme.getPrimaryControl(); // getPrimary3颜色
//		ESL esl = new ESL(c);
//		esl = esl.toDraker(70);
//		setSubBackground(canvas, esl.toColor());
//	} else {
//		Color color = new ESL(141, 115, 115).toColor();
//		setSubBackground(canvas, color);
//	}
//}
