 ...
 * @since laxcus 1.0
 */
public class RayPropertiesDialog extends RayLightDialog implements ActionListener {

	private static final long serialVersionUID = -5666450111548528063L;

	/** 自定义句柄 **/
	static RayPropertiesDialog selfHandle;

	/**
	 * 返回句柄
	 * @return 句柄
	 */
	public static RayPropertiesDialog getInstance() {
		return RayPropertiesDialog.selfHandle;
	}
	 ...
	 * 构造版本窗口
	 */
	public RayPropertiesDialog(PlatformDesktop d, RayUIUpdater u) {
		super();
		desktop = d;
		updater = u;
	}
	...
	public void closeWindow() {
		super.closeWindow();
		RayPropertiesDialog.selfHandle = null;
	}
	...
	//
	//		LocalSelector selector = new LocalSelector("conf/ray/about/config.xml");	
	//		String path = selector.findPath("resource");
	//
	//		// 设置图片
	//		ResourceLoader loader = new ResourceLoader();
	//		ImageIcon icon = loader.findImage("conf/ray/image/about/logo.png");
	//		if (icon != null) {
	//			image.setIcon(icon);
	//		}
	//
	...
	////		setTitle("系统属性");
	//////		setFrameIcon(findImage("conf/ray/image/window/system/screen.png"));
	...
	public Object showDialog(Component bind, boolean modal) {
		...
		// 赋值句柄
		RayPropertiesDialog.selfHandle = this;
