 ...
 * @since laxcus 1.0
 */
public class WorkSeekOnlineResourceInvoker extends WorkInvoker {

	/**
	 * 构造检索站点在线资源调用器，指定命令
	 * @param cmd 检索站点在线资源
	 */
	public WorkSeekOnlineResourceInvoker(SeekOnlineResource cmd) {
		super(cmd);
	}
	...
	public boolean launch() {
		...
		// 保存阶段命名
		product.addPhases(ToTaskPool.getInstance().getPhases());
		product.addPhases(DistantTaskPool.getInstance().getPhases());
