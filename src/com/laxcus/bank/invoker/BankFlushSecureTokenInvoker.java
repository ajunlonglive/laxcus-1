 ...
 * @since laxcus 1.0
 */
public class BankFlushSecureTokenInvoker extends HubFlushSecureTokenInvoker {

	/**
	 * 构造重装输出密钥令牌调用器，指定命令
	 * @param cmd 输出密钥令牌
	 */
	public BankFlushSecureTokenInvoker(FlushSecureToken cmd) {
		super(cmd);
	}

	/*
	 * (non-Javadoc)
	 * @see com.laxcus.echo.invoke.common.HubReloadSecureInvoker#fetchSubSites()
	 */
	@Override
