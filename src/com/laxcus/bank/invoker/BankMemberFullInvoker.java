 ...
 * @since laxcus 1.0
 */
public class BankMemberFullInvoker extends BankInvoker {

	/**
	 * 构造用户虚拟空间耗尽调用器，指定命令
	 * @param cmd 用户虚拟空间耗尽
	 */
	public BankMemberFullInvoker(MemberFull cmd) {
		super(cmd);
	}
	...
	public boolean launch() {
		...
		MemberFull sub = (cmd.getSite() == null ? 
				new MemberFull(getLocal()) : cmd.duplicate());
