 ...
 * @since laxcus 1.0
 */
public class BankReplyPacketModeInvoker extends HubReplyPacketModeInvoker {

	/**
	 * 构造设置应答数据传输模式调用器，指定命令
	 * @param cmd 设置应答数据传输模式
	 */
	public BankReplyPacketModeInvoker(ReplyPacketMode cmd) {
		super(cmd);
	}
...
//	/*
//	 * (non-Javadoc)
//	 * @see com.laxcus.echo.invoke.common.HubReplyPacketModeInvoker#isBottomSite(byte)
//	 */
//	@Override
