...
/**
 * BANK站点的重新发布自定义包命令调用器。
 * 
 * @author scott.liang
 * @version 1.0 6/26/2018
 * @since laxcus 1.0
 */
public class BankReloadCustomInvoker extends HubReloadCustomInvoker {

	/**
	 * 构造BANK站点的重新发布自定义包命令调用器，指定命令
	 * @param cmd 重新发布自定义包命令
	 */
	public BankReloadCustomInvoker(ReloadCustom cmd) {
		super(cmd);
	}
	...
	protected List<Node> fetchSubSites() {
		...
		// 如果是监视站点，不生成子站点
		BankLauncher launcher = (BankLauncher) super.getLauncher();
