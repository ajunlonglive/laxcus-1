...
/**
 * BANK站点开放TIGGER操作类型调用器。<br>
 * 
 * @author scott.liang
 * @version 1.0 1/24/2020
 * @since laxcus 1.0
 */
public class BankOpenTiggerInvoker extends HubOpenTiggerInvoker {

	/**
	 * 构造BANK站点开放TIGGER操作类型调用器，指定命令
	 * @param cmd 站点开放TIGGER操作类型命令
	 */
	public BankOpenTiggerInvoker(OpenTigger cmd) {
		super(cmd);
	}
