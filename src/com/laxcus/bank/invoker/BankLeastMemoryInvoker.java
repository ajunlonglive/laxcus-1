...
/**
 * BANK站点节点最小内存限制调用器。<br>
 * 
 * @author scott.liang
 * @version 1.0 8/8/2019
 * @since laxcus 1.0
 */
public class BankLeastMemoryInvoker extends HubLeastMemoryInvoker {

	/**
	 * 构造BANK站点节点最小内存限制调用器，指定命令
	 * @param cmd 节点最小内存限制命令
	 */
	public BankLeastMemoryInvoker(LeastMemory cmd) {
		super(cmd);
	}
