 ...
 * @since laxcus 1.0
 */
public class BankReplyFlowControlInvoker extends HubReplyFlowControlInvoker {

	/**
	 * 构造应答数据流量控制参数调用器，指定命令
	 * @param cmd 应答数据流量控制参数
	 */
	public BankReplyFlowControlInvoker(ReplyFlowControl cmd) {
		super(cmd);
	}

	/*
	 * (non-Javadoc)
	 * @see com.laxcus.echo.invoker.common.HubReplyFlowControlInvoker#fetchSubSites()
	 */
	@Override
