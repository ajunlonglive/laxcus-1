 ...
 * @since laxcus 1.0
 */
public class BankCreateSecureTokenInvoker extends HubCreateSecureTokenInvoker {

	/**
	 * 构造建立密钥令牌调用器，指定命令
	 * @param cmd 建立密钥令牌
	 */
	public BankCreateSecureTokenInvoker(CreateSecureToken cmd) {
		super(cmd);
	}

	/*
	 * (non-Javadoc)
	 * @see com.laxcus.echo.invoke.common.HubCreateSecureTokenInvoker#fetchSubSites()
	 */
	@Override
