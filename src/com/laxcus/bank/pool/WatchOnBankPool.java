...
/**
 * 在BANK站点上的WATCH站点管理池。<br>
 * 
 * @author scott.liang
 * @version 1.0 5/23/2013
 * @since laxcus 1.0
 */
public final class WatchOnBankPool extends BankPool {

	/** 静态句柄 **/
	private static WatchOnBankPool selfHandle = new WatchOnBankPool();
	 ...
	 * @return
	 */
	public static WatchOnBankPool getInstance() {
		return WatchOnBankPool.selfHandle;
	}
