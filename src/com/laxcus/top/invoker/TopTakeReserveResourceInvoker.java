 ...
 * 
 * 这个调用器运行在TOP管理站点，向TOP镜像站点发送资源数据文件。
 * 
 * @author scott.liang
 * @version 1.0 7/21/2014
 * @since laxcus 1.0
 */
public class TopTakeReserveResourceInvoker extends TopInvoker implements SerialSchedule {
	 ...
	 */
	public TopTakeReserveResourceInvoker(TakeReserveResource cmd) {
		super(cmd);
	}
	...
	public boolean launch() {
		...
		Logger.debug(this, "launch", success, "%s", filename);
