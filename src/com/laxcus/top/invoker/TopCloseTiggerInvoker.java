...
/**
 * TOP站点关闭TIGGER操作类型调用器。<br>
 * 
 * @author scott.liang
 * @version 1.0 1/24/2020
 * @since laxcus 1.0
 */
public class TopCloseTiggerInvoker extends HubCloseTiggerInvoker {

	/**
	 * 构造TOP站点关闭TIGGER操作类型调用器，指定命令
	 * @param cmd 站点关闭TIGGER操作类型命令
	 */
	public TopCloseTiggerInvoker(CloseTigger cmd) {
		super(cmd);
	}
