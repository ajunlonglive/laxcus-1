 ...
 * @since laxcus 1.0
 */
public final class EntranceInvokerPool extends InvokerPool {

	/** 异步调用器管理池 **/
	private static EntranceInvokerPool selfHandle = new EntranceInvokerPool();

	/**
	 * 构造一个默认和私有的ENTRANCE站点调用器管理池。
	 */
	private EntranceInvokerPool() {
		super();
	}

	/**
	 * 返回ENTRANCE站点调用器管理池静态句柄
	 * @return ENTRANCE站点调用器管理句柄
	 */
	public static EntranceInvokerPool getInstance() {
		return EntranceInvokerPool.selfHandle;
	}
