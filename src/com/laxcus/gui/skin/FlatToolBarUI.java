 ...
 * @since laxcus 1.0
 */
public class FlatToolBarUI extends MetalToolBarUI {

	class FlatToolBarBorder extends AbstractBorder implements UIResource {
		...
		public void paintBorder(Component c, Graphics g, int x, int y, int w, int h) {
			...
			// 不是亮色
			if (!Skins.isGraySkin()) {
				color = UIManager.getColor("ToolBar.background");
				if (color == null) {
	...
	public void installUI(JComponent c){
		...
		c.setBorder(new FlatToolBarBorder());
	}
