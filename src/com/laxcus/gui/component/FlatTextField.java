...
public class FlatTextField extends JTextField {
	...
	private static final long serialVersionUID = -1531073679194755739L;
	 ...
	 * @param arg0
	 */
	public FlatTextField(String arg0) {
		super(arg0);
		init();
	}
	 ...
	 * @param arg1
	 */
	public FlatTextField(String arg0, int arg1) {
		super(arg0, arg1);
		init();
	}
	 ...
	 * @param arg2
	 */
	public FlatTextField(Document arg0, String arg1, int arg2) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see javax.swing.AbstractTextField#paintBorder(java.awt.Graphics)
	 */
	@Override
...
//	}
	...
	private void paintMetalLightBorder(Component c, Graphics g, int x, int y,
		...
		// 灰色的时候，颜色变暗，否则是变亮
		if (Skins.isGraySkin()) {
			color = esl.toBrighter(FlatTextField.DRAK_VALUE).toColor();
		} else {
	...
	private void paintMetalDarkBorder(Component c, Graphics g, int x, int y,
		...
		//	Color dark = esl.toDraker(FlatTextField.DRAK_VALUE).toColor();
