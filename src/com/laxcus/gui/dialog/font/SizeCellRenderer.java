 ...
 * @since laxcus 1.0
 */
final class SizeCellRenderer extends JLabel implements ListCellRenderer {
	...
	public Component getListCellRendererComponent(JList list, Object value,
		...
		boolean success = (value != null && value.getClass() == Integer.class);
		if (!success) {
			setText("");
			return this;
		}
		...
		// 设置文字
		Integer rt = (Integer) value;
		setText(String.format("%d", rt.intValue()));
