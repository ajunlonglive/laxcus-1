 ...
 * @since laxcus 1.0
 */
class FileEncodeRenderer extends JLabel implements ListCellRenderer {
	...
	public Component getListCellRendererComponent(JList list, Object value,
		...
		if (value == null) {
			...
			setText("");
			return this;
		} else if (!(value instanceof EncodeType)) {
			setIcon(null);
			setText("");
			return this;
		}
		...
		// 文本...
		EncodeType ff = (EncodeType) value;
