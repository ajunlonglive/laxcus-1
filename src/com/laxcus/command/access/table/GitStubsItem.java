 ...
 * @since laxcus 1.0
 */
public final class GitStubsItem implements Classable, Serializable, Cloneable, java.lang.Comparable<GitStubsItem> {
	 ...
	 */
	private GitStubsItem(GitStubsItem that) {
		this();
		site = that.site;
	 ...
	 * @param a 数据块编号集合
	 */
	public GitStubsItem(Collection<Long> a) {
		this();
		addAll(a);
	}
	 ...
	 * @since 1.1
	 */
	public GitStubsItem(ClassReader reader) {
		this();
		resolve(reader);
	}
...
//	 * @param that StubResult实例
//	 */
//	public void AND(StubResult that) {
//		AND(that.array);
//	}
//
//	/**
...
//	/**
//	 * 逻辑"或"操作
//	 * @param set StubResult实例
//	 */
//	public void OR(StubResult set) {
//		OR(set.array);
//	}
	 ...
	 */
	public int addAll(GitStubsItem that) {
		int size = array.size();
		if (that != null) {
			array.addAll(that.array);
		}
...
//	 * @return 一致返回真，否则假。
//	 */
//	public boolean alike(StubResult that) {
//		// 1. 参数有效
...
//	}
	 ...
	 */
	@Override
	public int compareTo(GitStubsItem that) {
		return Laxkit.compareTo(this.site, that.site);
	}
