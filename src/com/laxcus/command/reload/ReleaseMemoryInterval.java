 ...
 * @since laxcus 1.0
 */
public class ReleaseMemoryInterval extends Command {
	 ...
	 */
	public ReleaseMemoryInterval(ClassReader reader) {
		this();
		resolve(reader);
	}
	...
	/**
	 * 生成释放节点内存命令的数据副本
	 * @param that ReleaseMemoryInterval实例
	 */
	private ReleaseMemoryInterval(ReleaseMemoryInterval that) {
		super(that);
	 ...
	 */
	@Override
	public ReleaseMemoryInterval duplicate() {
		return new ReleaseMemoryInterval(this);
	}
