 ...
 * @since laxcus 1.0
 */
public class AccountDeployConductSystemPackageInvoker extends AccountDeploySystemPackageInvoker {

	/**
	 * 构造部署分布计算系统应用调用器
	 * @param cmd 部署分布计算系统应用命令
	 */
	public AccountDeployConductSystemPackageInvoker(DeployConductSystemPackage cmd) {
		super(cmd);
	}
	 ...
	 */
	@Override
	public DeployConductSystemPackage getCommand() {
		return (DeployConductSystemPackage)super.getCommand();
	}
