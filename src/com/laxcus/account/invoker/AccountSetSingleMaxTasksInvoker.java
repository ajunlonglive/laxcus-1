 ...
 * @since laxcus 1.0
 */
public class AccountSetSingleMaxTasksInvoker extends AccountInvoker {

	/**
	 * 构造账号最多应用软件调用器，指定命令
	 * @param cmd 账号最多应用软件
	 */
	public AccountSetSingleMaxTasksInvoker(SetSingleMaxTasks cmd) {
		super(cmd);
	}
	 ...
	 */
	@Override
	public SetSingleMaxTasks getCommand() {
		return (SetSingleMaxTasks) super.getCommand();
	}
	...
	public boolean launch() {
		SetSingleMaxTasks cmd = getCommand();
		...
		if (success) {
			sphere.getAccount().getUser().setTasks(cmd.getTasks());
