 ...
 * @since laxcus 1.0
 */
public class AccountSetMemberCyberInvoker extends AccountInvoker {

	/**
	 * 构造设置成员虚拟空间参数调用器，指定命令
	 * @param cmd 设置成员虚拟空间参数
	 */
	public AccountSetMemberCyberInvoker(SetMemberCyber cmd) {
		super(cmd);
	}
	...
	public boolean launch() {
		...
		// 根据命令，设置分布处理超时
		if (success) {
			AccountLauncher launcher = getLauncher();
