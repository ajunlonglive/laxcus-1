 ...
 * @since laxcus 1.0
 */
public class AccountDeployEstablishSystemPackageInvoker extends AccountDeploySystemPackageInvoker {

	/**
	 * 构造部署分布构建系统应用调用器
	 * @param cmd 部署分布构建系统应用命令
	 */
	public AccountDeployEstablishSystemPackageInvoker(DeployEstablishSystemPackage cmd) {
		super(cmd);
	}
	 ...
	 */
	@Override
	public DeployEstablishSystemPackage getCommand() {
		return (DeployEstablishSystemPackage)super.getCommand();
	}
