 ...
 * <1> permission com.laxcus.log.client.TiggerPermission "using.*"; 允许所有用户使用操作 <br>
 * <2> permission com.laxcus.log.client.TiggerPermission "using.debug|using.info|using.warning|using.error|using.fatal"; 允许所有用户使用其中一种操作 <br>
 * <3> permission com.laxcus.log.client.TiggerPermission "using.*", "用户签名（64个16进制字符，忽略大小写）"; 允许某个用户使用全部操作 <br><br>
 * <4> permission com.laxcus.log.client.TiggerPermission "using.debug|using.info|using.warning|using.error|using.fatal", "用户签名（64个16进制字符，忽略大小写）,用户签名"; 允许某个用户使用其中一种或者几种操作，多个用户签名用逗号隔开。 <br><br> 
 * <5> permission com.laxcus.log.client.TiggerPermission "using.debug|using.info|using.warning|using.error|using.fatal", "用户明文名称,用户明文名称"; 允许多个用户名称一起，中间用逗号隔开 <br><br>
 * 
 * @author scott.liang
 * @version 1.0 1/6/2020
 * @since laxcus 1.0
 */
public class TiggerPermission extends BasicPermission {
	 ...
	 * @param name 目标名称
	 */
	public TiggerPermission(String name) {
		super(name);
	}
	 ...
	 */
	public TiggerPermission(String name, String actions) {
		super(name, actions);
		setIssuers(actions);
	}
	...
	public PermissionCollection newPermissionCollection() {
		return new TiggerPermissionCollection();
	}
}