...
public class MenuBuilder {
	...
	private static KeyStroke getShortcut(String shortcutKey) {
		...
		// 快捷键
		String text = UIManager.getString(shortcutKey);
		if (text != null) {
	 ...
	 * @return
	 */
	public static char getMnemonic(String mnemonicKey) {
		if (mnemonicKey == null) {
			return 0;
		}
		String ws = UIManager.getString(mnemonicKey);
	 ...
	 * @return
	 */
	public static boolean isWord(char w) {
	 ...
	 * @return
	 */
	public static JMenuItem createMenuItem(JMenuItem item, Icon icon, String iconKey, String textKey, 
		...
		// 方法名
		if (methodKey != null) {
			String name = UIManager.getString(methodKey);
			if (name != null) {
				item.setName(name);
			}
		}
...
//		item.setBorder(new EmptyBorder(4, 4, 4, 4));
	 ...
	 * @return
	 */
	public static JMenuItem createMenuItem(Icon icon, String iconKey, String textKey,
			String mnemonicKey, String shortcutKey, String methodKey, ActionListener listener) {

		JMenuItem item = new JMenuItem();
		return createMenuItem(item, icon, iconKey, textKey, mnemonicKey, shortcutKey,
