 ...
 * @since laxcus 1.0
 */
public class CallSeekFrontUserInvoker extends CallInvoker {

	/**
	 * 构造检索FRONT在线用户，指定命令
	 * @param cmd 检索FRONT在线用户命令
	 */
	public CallSeekFrontUserInvoker(SeekFrontUser cmd) {
		super(cmd);
	}
	...
	public boolean launch() {
		...
		if (cmd.isAllUser()) {
			array.addAll(FrontOnCallPool.getInstance().getSigers());
		} else {
