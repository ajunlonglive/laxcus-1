 ...
 * @since laxcus 1.0
 */
public class MeetLocalDeployConductPackageInvoker extends MeetLocalDeployCloudPackageInvoker {

	/**
	 * 构造部署分布计算应用软件包，指定命令
	 * @param cmd 部署分布计算应用软件包
	 */
	public MeetLocalDeployConductPackageInvoker(DeployConductPackage cmd) {
		super(cmd);
	}
