 ...
 * 
 * @author scott.liang
 * @version 1.1 10/28/2015
 * @since laxcus 1.0
 */
public class MeetModulateInvoker extends MeetInvoker {

	/**
	 * 构造数据调整命令的调用器
	 * @param cmd 数据调整命令
	 */
	public MeetModulateInvoker(Modulate cmd) {
		super(cmd);
	}
	...
	public boolean launch() {
		...
		boolean success = getCommandPool().press(establish);
