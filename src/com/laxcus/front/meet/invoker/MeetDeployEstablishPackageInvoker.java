 ...
 * @since laxcus 1.0
 */
public class MeetDeployEstablishPackageInvoker extends MeetDeployCloudPackageInvoker {

	/**
	 * 构造部署分布数据构建应用软件包，指定命令
	 * @param cmd 部署分布数据构建应用软件包
	 */
	public MeetDeployEstablishPackageInvoker(DeployEstablishPackage cmd) {
		super(cmd);
	}
