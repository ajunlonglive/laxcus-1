 ...
 * 
 * @author scott.liang
 * @version 1.0 2/28/2028
 * @since laxcus 1.0
 */
public class MeetDropCloudDirectoryInvoker extends MeetHubServiceInvoker {

	/**
	 * 构造删除云端目录调用器
	 * @param cmd 删除云端目录
	 */
	public MeetDropCloudDirectoryInvoker(DropCloudDirectory cmd) {
		super(cmd);
	}
