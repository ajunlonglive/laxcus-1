 ...
 * @since laxcus 1.0
 */
public class MeetSystemDeployContactPackageInvoker extends MeetSystemDeployCloudPackageInvoker {

	/**
	 * 构造部署迭代计算应用软件包，指定命令
	 * @param cmd 部署迭代计算应用软件包
	 */
	public MeetSystemDeployContactPackageInvoker(DeployContactPackage cmd) {
		super(cmd);
	}
