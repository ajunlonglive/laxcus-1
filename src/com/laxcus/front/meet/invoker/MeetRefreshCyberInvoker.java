 ...
 * @since laxcus 1.0
 */
public class MeetRefreshCyberInvoker extends MeetInvoker {
	 ...
	 * @param cmd 更新私有网络空间
	 */
	public MeetRefreshCyberInvoker(RefreshCyber cmd) {
		super(cmd);
		setDelayTime(0);
	}
...
//		checkPocks(spaces.keySet());
	...
	private boolean loadAuthorizerCallSite(Node node, Space space) {
		...
		Logger.note(this, "loadAuthorizerCallSite", success, "save <%s %s>",
				node, space);
