 ...
 * @since laxcus 1.0
 */
public class MeetCheckRemoteSiteInvoker extends MeetInvoker {

	/**
	 * 构造显示连接节点调用器，指定命令
	 * @param cmd 显示连接节点
	 */
	public MeetCheckRemoteSiteInvoker(CheckRemoteSite cmd) {
		super(cmd);
	}
	...
	public boolean launch() {
		...
		createShowTitle(new String[] { "CHECK-REMOTE-SITE/TYPE",
				"CHECK-REMOTE-SITE/SITE" });
		...
		// CLOUD STORE SITE
		List<Node> clouds = getStaffPool().getCloudSites();
