 ...
 * @since laxcus 1.0
 */
public class MeetSelectInvoker extends MeetQueryInvoker {

	/**
	 * 构造SELECT命令调用器，指定SELECT命令
	 * @param cmd SELECT命令
	 */
	public MeetSelectInvoker(Select cmd) {
		super(cmd);
	}
	 ...
	 * 
	 * @see com.laxcus.front.meet.invoker.MeetInvoker#launch()
	 * @return 成功返回“真”，否则“假”。
	 */
	@Override
	...
	private boolean createDirectSelect() {
		Select cmd = getCommand();
		MeetDirectSelectInvoker invoker = new MeetDirectSelectInvoker(cmd);
