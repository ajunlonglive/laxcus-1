 ...
 * @since research 1.0
 */
public class MeetShiftSingleImportEntityInvoker extends MeetInvoker {
	...
	/*
	 * (non-Javadoc)
	 * @see com.laxcus.front.meet.invoker.MeetRuleInvoker#destroy()
	 */
	@Override
	public void destroy() {
		if (reader != null) {
	 ...
	 * @param cmd 数据导入命令
	 */
	public MeetShiftSingleImportEntityInvoker(ShiftSingleImportEntity cmd) {
		super(cmd);
		step = 1; // 从1开始
		count = 0;
	}
