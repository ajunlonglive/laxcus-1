 ...
 * 
 * @author scott.liang
 * @version 1.0 10/13/2018
 * @since laxcus 1.0
 */
public class MeetReleaseMemoryIntervalInvoker extends MeetInvoker {

	/**
	 * 构造释放节点内存间隔命令调用器，指定命令
	 * @param cmd 释放节点内存间隔命令
	 */
	public MeetReleaseMemoryIntervalInvoker(ReleaseMemoryInterval cmd) {
		super(cmd);
	}
