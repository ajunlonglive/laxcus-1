 ...
 * 
 * MeetInvoker应用于终端、控制台两种模式。基于用户的可视化操作和调用。<br>
 * 
 * MeetInvoker操作由用户产生，每次关联一个异步命令，注册到MeetInvokerPool <br><br>
 * 
 * @author scott.liang
 * @version 1.5 7/19/2015
 * @since laxcus 1.0
 */
public abstract class MeetInvoker extends FrontDisplayInvoker {
	...
	private static void loadInvokerSurface() {
		LocalSelector selector = new LocalSelector("conf/front/invoker/config.xml");
...
//	/** 前端显示器。显示命令操作过程中产生信息 **/
//	private static MeetDisplay display;
//
//	/**
//	 * 设置静态的前端显示器。在进程启动时设置
//	 * @param e MeetDisplay实例
//	 */
//	public static void setDisplay(MeetDisplay e) {
//		MeetInvoker.display = e;
//	}
//
//	/**
//	 * 返回静态的前端显示器
...
//	 */
//	public static MeetDisplay getDisplay() {
//		return MeetInvoker.display;
//	}
...
//		sound = true; // 默认是真
	 ...
	 * @param cmd 异步命令
	 */
	protected MeetInvoker(Command cmd) {
		super(cmd);
		// 清除状态栏信息
		if (isTerminal()) {
			setStatusText("");
...
//		sound = true;
	 ...
	 */
	@Override
	public MeetLauncher getLauncher() {
		return (MeetLauncher) super.getLauncher();
	}
...
//	}
	...
	protected ShowItemCell createConfirmTableCell(int index, boolean successful) {
		...
		if (successIcon == null && failedIcon == null) {
			ResourceLoader loader = new ResourceLoader("conf/front/terminal/image/invoker/");
...
//	/*
//	 * (non-Javadoc)
//	 * @see com.laxcus.front.invoker.DisplayInvoker#playMessage()
//	 */
//	@Override
...
//	/*
//	 * (non-Javadoc)
//	 * @see com.laxcus.front.invoker.DisplayInvoker#playWarning()
//	 */
//	@Override
...
//	/*
//	 * (non-Javadoc)
//	 * @see com.laxcus.front.invoker.DisplayInvoker#playError()
//	 */
//	@Override
...
//		MeetInvoker.display.message(text, focus);
//		if (play) {
//			playMessage();
//		}
//	}
...
//		MeetInvoker.display.warning(text, focus);
//		// 播放警告声音
//		if (play) {
//			playWarning();
//		}
...
//		MeetInvoker.display.fault(text, focus);
//		// 播放错误声音
//		if (play) {
//			playError();
//		}
...
//		MeetInvoker.display.showTable(title, items);
//	}
...
//		return MeetInvoker.display.getTitleCellCount();
//	}
//
//	/**
//	 * 设置状态栏消息
...
//		MeetInvoker.display.setStatusText(text);
//	}
