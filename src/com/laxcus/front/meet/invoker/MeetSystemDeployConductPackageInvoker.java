 ...
 * @since laxcus 1.0
 */
public class MeetSystemDeployConductPackageInvoker extends MeetSystemDeployCloudPackageInvoker {

	/**
	 * 构造部署分布计算应用软件包，指定命令
	 * @param cmd 部署分布计算应用软件包
	 */
	public MeetSystemDeployConductPackageInvoker(DeployConductPackage cmd) {
		super(cmd);
	}
...
//		component.setSelfly(false);
	...
	/*
	 * (non-Javadoc)
	 * @see com.laxcus.front.meet.invoker.MeetSystemDeployCloudPackageInvoker#deploySystem()
	 */
	@Override
