 ...
 * 
 * @author scott.liang
 * @version 1.3 8/23/2015
 * @since laxcus 1.0
 */
public class DriverEstablishInvoker extends DriverRuleInvoker {

	/** ESTABLISH处理步骤 **/
	private int step = 1;

	/**
	 * 构造ESTABLISH命令调用器，指定驱动任务
	 * @param mission 驱动任务
	 */
	public DriverEstablishInvoker(DriverMission mission) {
		super(mission);
		createRule();
	}
	...
	/**
	 * 接收ESTABLISH命令处理结果，把结果数据保存到驱动结果中
	 * @return 处理成功返回真，否则假
	 */
