 ...
 * @since laxcus 1.0
 */
public class DriverConductInvoker extends DriverRuleInvoker {

	/** CONDUCT处理步骤，从1开始 **/
	private int step = 1;

	/**
	 * 构造CONDUCT命令调用器，指定驱动任务
	 * @param mission 驱动任务
	 */
	public DriverConductInvoker(DriverMission mission) {
		super(mission);
		createRule();
	}
	...
	/**
	 * 接收CONDUCT命令处理结果，把结果数据保存到DRIVER结果中
	 * @return 处理成功返回真，否则假
	 */
