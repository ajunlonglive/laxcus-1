 ...
 * @since laxcus 1.0
 */
public class TerminalGraphCellRenderer extends JLabel implements ListCellRenderer {
...
//	private Color textSelectForeground, textSelectBackground;
	 ...
	 * 构造消息显示单元
	 */
	public TerminalGraphCellRenderer() {
		super();
		init();
	}
...
//		textSelectBackground = Skins.findListTextSelectBackground();
	...
	public Component getListCellRendererComponent(JList list, Object value,
		...
		// 只支持这两个对象！
		boolean success = (value.getClass() == GraphIconCell.class || value
				.getClass() == GraphTextCell.class);
		if (!success) {
			setIcon(null);
			setText("");
			return this;
