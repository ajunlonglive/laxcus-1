 ...
 * @since laxcus 1.0
 */
public class TerminalCheckEntityContentDialog extends TerminalCommonFontDialog implements ActionListener {

	private static final long serialVersionUID = -8742839896589166904L;
	 ...
	 * @param modal 模态
	 */
	public TerminalCheckEntityContentDialog(Frame parent, boolean modal) {
		super(parent, modal);
	}
	...
	private void warning(){
		// 提示错误
		String title = findCaption("Dialog/CheckEntityContent/warning/title");
		String content = findContent("Dialog/CheckEntityContent/warning");
	...
	private boolean exit() {
		...
		String content = findCaption("Dialog/CheckEntityContent/exit/message/title");
	 ...
	 */
	private void fire() {
		String cmd = String.format("CHECK ENTITY CONTENT %s FROM ", getTable());
		int size = array.size();
	...
	private void chooseFiles() {
		String title = findCaption("Dialog/CheckEntityContent/file-chooser/title/title");
		String buttonText = findCaption("Dialog/CheckEntityContent/file-chooser/selected/title");

		// TEXT文件
		String ds_text = findCaption("Dialog/CheckEntityContent/file-chooser/text/description/title");
		String text = findCaption("Dialog/CheckEntityContent/file-chooser/text/extension/title");
		// CSV文件
		String ds_csv = findCaption("Dialog/CheckEntityContent/file-chooser/csv/description/title");
		String csv = findCaption("Dialog/CheckEntityContent/file-chooser/csv/extension/title");
...
//		}
		...
		// 提示文本
		setToolTipText(lstFile, findCaption("Dialog/CheckEntityContent/list/file/tooltip"));
		
		setButtonText(cmdChoose, findCaption("Dialog/CheckEntityContent/buttons/choose/title"));
		cmdChoose.addActionListener(this);
		
		setButtonText(cmdDelete, findCaption("Dialog/CheckEntityContent/buttons/delete/title"));
		cmdDelete.addActionListener(this);
		
		setButtonText(cmdOK, findCaption("Dialog/CheckEntityContent/buttons/okay/title"));
		cmdOK.setMnemonic('O');
		cmdOK.addActionListener(this);

		setButtonText(cmdCancel, findCaption("Dialog/CheckEntityContent/buttons/cancel/title"));
	...
	private JPanel createFilePanel() {
		...
		sub.setLayout(new BorderLayout(2, 0));
		sub.add(createTablePanel(), BorderLayout.WEST);
		sub.add(createFileButtonPanel(), BorderLayout.EAST);
	...
	private JPanel createFileButtonPanel() {
		...
		north.setLayout(new GridLayout(1, 2, 6, 0));
		north.add(cmdChoose);
		north.add(cmdDelete);
	...
	private JPanel createTablePanel() {
		...
		setLabelText(label, findCaption("Dialog/CheckEntityContent/label/table/title"));
	...
	private JPanel createTypePanel() {
		JLabel label = new JLabel();
		setLabelText(label, findCaption("Dialog/CheckEntityContent/label/type/title"));
		label.setHorizontalAlignment(SwingConstants.LEFT);
	...
	private JPanel createCharsetPanel() {
		JLabel label = new JLabel();
		setLabelText(label, findCaption("Dialog/CheckEntityContent/label/charset/title"));
		label.setHorizontalAlignment(SwingConstants.LEFT);
	...
	private JPanel createParamPanel() {
		JPanel sub = new JPanel();
		sub.setLayout(new GridLayout(2, 1, 0, 12));
	...
	private JPanel createCenterPanel() {
		...
		// 文件面板
		String fileText = findCaption("Dialog/CheckEntityContent/panel/file/title"); // "数据文件";
		String paramText = findCaption("Dialog/CheckEntityContent/panel/param/title"); //"数据参数";
...
//		right.setBorder(paramBorder);
	...
	public void showDialog() {
		...
		// 标题
		String title = findCaption("Dialog/CheckEntityContent/title");
		setTitle(title);
