 ...
 * @since laxcus 1.0
 */
public class TerminalWareTaskRenderer extends JLabel implements ListCellRenderer {
	 ...
	 * 构造消息显示单元
	 */
	public TerminalWareTaskRenderer() {
		super();
		init();
	}
	...
	public Component getListCellRendererComponent(JList list, Object value,
		...
		// 传入对象是String
		if (value == null || value.getClass() != TaskToken.class) {
			setIcon(null);
			setText("");
			return this;
		}
		...
		String naming = ((TaskToken) value).getNaming();
		// 文字和图标
