 ...
 * @since laxcus 1.0
 */
public class TerminalTrackDialog extends JDialog implements FrontLoginTracker, Runnable {
	 ...
	 * @param modal
	 */
	public TerminalTrackDialog(JDialog owner, boolean modal) {
		super(owner, modal);
	...
	private void init() {
		...
		icon = loader.findImage("conf/front/terminal/image/login/ball.png");
	}
