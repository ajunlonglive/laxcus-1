 ...
 * @since laxcus 1.0
 */
public class TerminalShowTubContainerDialog extends TerminalCommonFontDialog implements ActionListener {

	private static final long serialVersionUID = 8651127706160050308L;

	private final static String BOUND = TerminalShowTubContainerDialog.class.getSimpleName() + "_BOUND";
	 ...
	 */
	public TerminalShowTubContainerDialog(Frame owner, boolean modal) throws HeadlessException {
		super(owner, modal);
	}
	...
	private void showParamMissing() {
		// xxx 是必选项，请输入！
		String title = findCaption("Dialog/ShowTub/missing/title");
		String content = findContent("Dialog/ShowTub/missing"); 
	...
	private boolean confirm() {
		String title = findCaption("Dialog/ShowTub/confirm/title");
		String content = findContent("Dialog/ShowTub/confirm");
	...
	private boolean cancel() {
		String title = findCaption("Dialog/ShowTub/cancel/title");
		String content = findContent("Dialog/ShowTub/cancel");
		int who = MessageDialog.showMessageBox(this, title, 
				JOptionPane.QUESTION_MESSAGE, content, JOptionPane.YES_NO_OPTION);
		return (who == JOptionPane.YES_OPTION);
	}
	...
	private void initControls() {
		setButtonText(cmdOK, findCaption("Dialog/ShowTub/buttons/okay/title"));
		cmdOK.setMnemonic('O');
		cmdOK.addActionListener(this);

		setButtonText(cmdCancel, findCaption("Dialog/ShowTub/buttons/cancel/title"));
		cmdCancel.setMnemonic('C');
		cmdCancel.addActionListener(this);

		setButtonText(cmdAll, findCaption("Dialog/ShowTub/buttons/all/title"));
...
//		sub.setMaximumSize(d);
	...
	private JPanel createCenter() {
		JLabel caption = new JLabel(findContent("Dialog/ShowTub/naming"));
		setSubSize(caption);
...
//		txtName.setBorder(UITools.createTitledBorder("", 1)); // 边框
	...
	public int showDialog() {
		...
		// 标题
		String title = findCaption("Dialog/ShowTub/title");
		setTitle(title);
