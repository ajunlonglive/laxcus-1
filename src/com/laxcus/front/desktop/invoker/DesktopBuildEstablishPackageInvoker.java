 ...
 * @since laxcus 1.0
 */
public class DesktopBuildEstablishPackageInvoker extends DesktopBuildCloudPackageInvoker {

	/**
	 * 构造生成ESTABLISH数据构建应用软件包调用器，指定命令
	 * @param cmd 生成ESTABLISH数据构建应用软件包
	 */
	public DesktopBuildEstablishPackageInvoker(BuildEstablishPackage cmd) {
		super(cmd);
	}
