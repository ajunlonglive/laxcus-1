 ...
 * @since laxcus 1.0
 */
public class DesktopPrintSchemaDiagramInvoker extends DesktopPrintResourceDiagramInvoker {

	/**
	 * 构造显示数据库状态的异步调用器，指定命令
	 * @param cmd 显示数据库状态
	 */
	public DesktopPrintSchemaDiagramInvoker(PrintSchemaDiagram cmd) {
		super(cmd);
	}
