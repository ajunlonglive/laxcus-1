 ...
 * @since laxcus 1.0
 */
public abstract class DesktopForbidInvoker extends DesktopInvoker {
	 ...
	 * @param cmd 禁止操作
	 */
	protected DesktopForbidInvoker(Command cmd) {
		super(cmd);
	}
	...
	private boolean checkRevoke() {
		...
		Logger.debug(this, "checkRevoke", success, "Goodbye!");
