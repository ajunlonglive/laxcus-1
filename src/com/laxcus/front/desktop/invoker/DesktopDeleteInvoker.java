 ...
 * @since laxcus 1.0
 */
public class DesktopDeleteInvoker extends DesktopQueryInvoker {

	/**
	 * 构造DELETE命令调用器，指定DELETE命令
	 * @param cmd DELETE命令
	 */
	public DesktopDeleteInvoker(Delete cmd) {
		super(cmd);
	}
	...
	private boolean createDirectDelete() {
		Delete delete = getCommand();
		DesktopDirectDeleteInvoker invoker = new DesktopDirectDeleteInvoker(delete);
