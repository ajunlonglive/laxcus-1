 ...
 * @since research 1.0
 */
public class DesktopShiftSingleImportEntityInvoker extends DesktopInvoker {
	...
	/*
	 * (non-Javadoc)
	 * @see com.laxcus.front.desktop.invoker.DesktopRuleInvoker#destroy()
	 */
	@Override
	public void destroy() {
		if (reader != null) {
	 ...
	 * @param cmd 数据导入命令
	 */
	public DesktopShiftSingleImportEntityInvoker(ShiftSingleImportEntity cmd) {
		super(cmd);
		step = 1; // 从1开始
		count = 0;
	}
	...
	private boolean todo() {
		...
		while (true) {
			...
			if (no == -1) {
				...
				String prefix = getXMLContent("IMPORT-ENTITY/FINISHED-X");
	...
	public boolean launch() {
		...
		// 提示: 上传...
		String tip = getXMLContent("IMPORT-ENTITY/UPLOAD");
		String upload = String.format(tip, file.toString());
		message(upload);
