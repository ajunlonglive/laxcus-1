 ...
 * @since laxcus 1.0
 */
public abstract class DesktopLocalDeployCloudPackageInvoker extends DesktopInvoker {
	 ...
	 */
	protected DesktopLocalDeployCloudPackageInvoker(DeployCloudPackage cmd) {
		super(cmd);
	}
