...
/**
 * 被授权人显示授权人开放给自己的数据资源调用器
 * 
 * @author scott.liang
 * @version 1.0 5/30/2021
 * @since laxcus 1.0
 */
public class DesktopShowPassiveResourceInvoker extends DesktopInvoker {

	/**
	 * 构造被授权人显示授权人开放给自己的数据资源调用器，指定命令
	 * @param cmd 被授权人显示授权人开放给自己的数据资源
	 */
	public DesktopShowPassiveResourceInvoker(ShowPassiveResource cmd) {
		super(cmd);
	}
	...
	private void print(List<ShareCrossItem> array) {
		...
		// 生成标题
		createShowTitle(new String[] { "SHOW-PASSIVE-RESOURCE/USERNAME",
				"SHOW-PASSIVE-RESOURCE/TABLE", "SHOW-PASSIVE-RESOURCE/OPERATOR",
				"SHOW-PASSIVE-RESOURCE/CREATETIME" });
