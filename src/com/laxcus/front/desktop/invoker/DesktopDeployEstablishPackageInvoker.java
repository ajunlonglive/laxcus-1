 ...
 * @since laxcus 1.0
 */
public class DesktopDeployEstablishPackageInvoker extends DesktopDeployCloudPackageInvoker {

	/**
	 * 构造部署分布数据构建应用软件包，指定命令
	 * @param cmd 部署分布数据构建应用软件包
	 */
	public DesktopDeployEstablishPackageInvoker(DeployEstablishPackage cmd) {
		super(cmd);
	}
	
	/*
	 * (non-Javadoc)
	 * @see com.laxcus.front.desktop.invoker.DesktopDeployCloudPackageInvoker#getCommand()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.laxcus.front.desktop.invoker.DesktopDeployCloudPackageInvoker#checkPermission()
	 */
	@Override
...
//		component.setSelfly(false);
	...
	private boolean deployTaskAssist(Naming ware, CloudPackageItem item) {
		...
		// 生成工作部件
		TaskPart part = new TaskPart(issuer, PhaseTag.END);
	...
	/* (non-Javadoc)
	 * @see com.laxcus.front.desktop.invoker.DesktopDeployCloudPackageInvoker#deployLocal()
	 */
	@Override
