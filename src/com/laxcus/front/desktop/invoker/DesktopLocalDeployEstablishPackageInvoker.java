 ...
 * @since laxcus 1.0
 */
public class DesktopLocalDeployEstablishPackageInvoker extends DesktopLocalDeployCloudPackageInvoker {

	/**
	 * 构造部署分布数据构建应用软件包，指定命令
	 * @param cmd 部署分布数据构建应用软件包
	 */
	public DesktopLocalDeployEstablishPackageInvoker(DeployEstablishPackage cmd) {
		super(cmd);
	}
...
//		component.setSelfly(false);
	...
	/*
	 * (non-Javadoc)
	 * @see com.laxcus.front.desktop.invoker.DesktopLocalDeployCloudPackageInvoker#deployLocal()
	 */
	@Override
