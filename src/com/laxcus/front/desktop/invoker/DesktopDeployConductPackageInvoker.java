 ...
 * @since laxcus 1.0
 */
public class DesktopDeployConductPackageInvoker extends DesktopDeployCloudPackageInvoker {

	/**
	 * 构造部署分布计算应用软件包，指定命令
	 * @param cmd 部署分布计算应用软件包
	 */
	public DesktopDeployConductPackageInvoker(DeployConductPackage cmd) {
		super(cmd);
	}
