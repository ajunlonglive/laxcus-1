 ...
 * @since laxcus 1.0
 */
public class DesktopLocalDeployContactPackageInvoker extends DesktopLocalDeployCloudPackageInvoker {

	/**
	 * 构造部署迭代计算应用软件包，指定命令
	 * @param cmd 部署迭代计算应用软件包
	 */
	public DesktopLocalDeployContactPackageInvoker(DeployContactPackage cmd) {
		super(cmd);
	}
