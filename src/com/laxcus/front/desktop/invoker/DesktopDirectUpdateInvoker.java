 ...
 * @since laxcus 1.0
 */
public class DesktopDirectUpdateInvoker extends DesktopRuleInvoker {
	 ...
	 * @param cmd UPDATE命令
	 */
	public DesktopDirectUpdateInvoker(Update cmd) {
		super(cmd);
		// 建立表规则
		init();
	}
	...
	/*
	 * (non-Javadoc)
	 * @see com.laxcus.front.meet.invoker.DesktopStageInvoker#process()
	 */
	@Override
