 ...
 * @since laxcus 1.0
 */
class EdgeBar extends DesktopPanel implements ActionListener, PlatformEdgeBar {
	...
	/** 监听器 **/
	private DesktopEdgeListener listener;
	 ...
	 * @param e
	 */
	public void setEdgeListener(DesktopEdgeListener e){
		listener = e;
	}
