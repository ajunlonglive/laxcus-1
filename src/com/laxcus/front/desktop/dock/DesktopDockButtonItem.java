 ...
 * @since laxcus 1.0
 */
public class DesktopDockButtonItem extends WProgram { 
	 ...
	 * @param that 按纽单元
	 */
	private DesktopDockButtonItem(DesktopDockButtonItem that) {
		super(that);
		system = that.system;
	 ...
	 * @param w
	 */
	public DesktopDockButtonItem(WProgram w) {
		super(w);
		createTime = System.currentTimeMillis();
	}
	 ...
	 * @param w
	 */
	public DesktopDockButtonItem(WProgram w, boolean system) {
		super(w);
		setSystem(system);
		createTime = System.currentTimeMillis();
	}
	 ...
	 * @param reader 可类化读取器
	 */
	public DesktopDockButtonItem(ClassReader reader) {
		this();
		resolve(reader);
	}
	 ...
	 */
	@Override
	public DesktopDockButtonItem duplicate(){
		return new DesktopDockButtonItem(this);
	}
