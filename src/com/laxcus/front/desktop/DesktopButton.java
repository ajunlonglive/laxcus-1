 ...
 * @since laxcus 1.0
 */
public class DesktopButton extends JPanel {
	...
	/** 参数 **/
	private DesktopButtonItem item;
	 ...
	 */
	public void setItem(DesktopButtonItem e) {
		item = e;
	}
	 ...
	 */
	public DesktopButtonItem getItem() {
		return item;
	}
...
//		lblName.setHorizontalAlignment(SwingConstants.TRAILING);
	...
	public void setFocus(boolean b) {
		...
		// 获得焦点时触发
		if (focus) {
			DesktopController.getInstance().doCancelRename();
		}
	}
...
// * @since laxcus 1.0
// */
//public final class DesktopButton extends CraftButton {
//
