 ...
 * @since laxcus 1.0
 */
class DesktopLogPanel extends JPanel implements ActionListener,LogTransmitter {
	...
	/** 渲染器 **/
	private DesktopLogCellRenderer renderer;
...
//	}
	...
	private JScrollPane createCenter(){
		renderer = new DesktopLogCellRenderer();
