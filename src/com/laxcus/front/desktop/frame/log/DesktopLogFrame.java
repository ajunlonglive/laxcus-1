 ...
 */
package com.laxcus.front.desktop.frame.log;
 ...
 * @since laxcus 1.0
 */
public class DesktopLogFrame extends DesktopFrame {

	private static final long serialVersionUID = -4266477207257904104L;
	
	static DesktopLogFrame selfHandle;
	
	/**
	 * 返回实例
	 * @return
	 */
	public static DesktopLogFrame getInstance() {
		return DesktopLogFrame.selfHandle;
	}
...
//	}
	...
	private DesktopLogPanel panel = new DesktopLogPanel();
	
	/**
	 * 构造日志框架
	 */
	public DesktopLogFrame() {
		super();
...
//	}
	...
	protected void release1() {
		DesktopLogFrame.selfHandle = null;
	}
