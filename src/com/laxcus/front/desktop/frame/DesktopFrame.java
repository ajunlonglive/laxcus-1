 ...
 */
package com.laxcus.front.desktop.frame;
 ...
 * @since laxcus 1.0
 */
public abstract class DesktopFrame extends LightFrame {
	 ...
	 * @param resizable
	 */
	public DesktopFrame(String title, boolean resizable) {
	 ...
	 * @param closable
	 */
	public DesktopFrame(String title, boolean resizable, boolean closable) {
	 ...
	 * @param maximizable
	 */
	public DesktopFrame(String title, boolean resizable, boolean closable, boolean maximizable) {
