 ...
 * @since laxcus 1.0
 */
public class DesktopRunDialog extends LightDialog implements ActionListener {

	private static final long serialVersionUID = -5107692562372768968L;

	/** 实例 **/
	static DesktopRunDialog selfHandle;

	/**
	 * 返回句柄
	 * @return 实例
	 */
	public static DesktopRunDialog getInstance() {
		return DesktopRunDialog.selfHandle;
	}
	...
	public void closeWindow() {
		super.closeWindow();
		DesktopRunDialog.selfHandle = null;
		//		System.out.println("关闭运行窗口");
	}
	...
	private boolean startApplication(String input) {
		...
		if (keys.length == 1) {
			...
			// 显示窗口
			DesktopMultiSelectDialog dlg = new DesktopMultiSelectDialog(array);
		...
		//		System.out.println("into waiting..");
		//		
		//		// 等待，直到完成
		//		waiter.start();
		//		waiter.await();
	...
	//	class RunWaiter extends DynamicWaiter {
	//		boolean successful;
	//
	//		public RunWaiter() {
	//			super();
	...
	//	class RunWaiter extends WorkThread {
	//		boolean successful;
	...
	private void initDialog() {
		...
		String text = UIManager.getString("RunDialog.contentText"); 
	...
	public Object showDialog(Component parent, boolean modal) {
		...
		DesktopRunDialog.selfHandle = this;
