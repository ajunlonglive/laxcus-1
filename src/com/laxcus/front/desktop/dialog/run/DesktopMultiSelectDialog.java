 ...
 * @since laxcus 1.0
 */
class DesktopMultiSelectDialog extends LightDialog implements ActionListener, ListSelectionListener {
	 ...
	 * @param collect
	 */
	public DesktopMultiSelectDialog(Collection<MultiSelectCommand> collect) {
		super();
...
//		panel.setBorder( new CompoundBorder(new HighlightBorder(1), BorderFactory.createEmptyBorder(2,2,2,2)));
