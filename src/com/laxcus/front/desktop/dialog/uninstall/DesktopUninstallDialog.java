 ...
 */
package com.laxcus.front.desktop.dialog.uninstall;
 ...
 * @since laxcus 1.0
 */
public class DesktopUninstallDialog extends LightDialog implements ActionListener, ListSelectionListener {
	 ...
	 * 构造默认的删除软件对话框
	 */
	public DesktopUninstallDialog(UninstallFactory e) {
		super();
		factory = e;
	}
