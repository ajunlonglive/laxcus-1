...
/**
 * Front.Desktop节点的界面属性
 * 
 * @author scott.liang
 * @version 1.0 5/18/2020
 * @since laxcus 1.0
 */
public class DesktopProperties extends LocalProperties {
	
	/**
	 * 写入字体
	 * @param font
	 */
	public static void writeSystemFont(Font font) {
		RElement element = RTEnvironment.getInstance().findElement(RTEnvironment.ENVIRONMENT_SYSTEM, "FONT");
		if (element == null) {
			element = new RElement("FONT");
			RTEnvironment.getInstance().addElement(RTEnvironment.ENVIRONMENT_SYSTEM, element);
		}
		
		RFolder folder = new RFolder("SYSTEM_FONT");
...
//		RToken token = element.find("SYSTEM_FONT");
//		if (token == null || token.getClass() != RFolder.class) {
//			return null;
//		}
//		RFolder floder = (RFolder) token;
//		RString name = (RString) floder.find("name");
//		RInteger style = (RInteger) floder.find("style");
//		RInteger size = (RInteger) floder.find("size");
//		return new Font(name.getValue(), style.getValue(), size.getValue());
	...
	/** 控制台窗口，对应Rectangle值 **/
	public static final String ConsoleBound = "bound.console";
	 ...
	 * @return
	 */
	public static Object writeConsoleBound(Rectangle e) {
		return putProperity(ConsoleBound, e);
	}
	 ...
	 * @return
	 */
	public static Rectangle readConsoleBound() {
		Object value = findProperity(ConsoleBound);
	...
	/** 帮助窗口，对应Rectangle值 **/
	public static final String HelpBound = "bound.help";
	 ...
	 * @return
	 */
	public static Object writeHelpBound(Rectangle e) {
		return putProperity(HelpBound, e);
	}
	 ...
	 * @return
	 */
	public static Rectangle readHelpBound() {
		Object value = findProperity(HelpBound);
		if (value != null && value.getClass() == Rectangle.class) {
			return (Rectangle) value;
		}
		return null;
	...
	/** 日志窗口，对应Rectangle值 **/
	public static final String LogBound = "bound.log";
	 ...
	 * @return
	 */
	public static Object writeLogBound(Rectangle e) {
		return putProperity(LogBound, e);
	}
	 ...
	 * @return
	 */
	public static Rectangle readLogBound() {
		Object value = findProperity(LogBound);
		if (value != null && value.getClass() == Rectangle.class) {
			return (Rectangle) value;
		}
		return null;
