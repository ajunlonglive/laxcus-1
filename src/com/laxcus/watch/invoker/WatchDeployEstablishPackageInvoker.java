 ...
 * @since laxcus 1.0
 */
public class WatchDeployEstablishPackageInvoker extends WatchDeployCloudPackageInvoker {

	/**
	 * 构造发布系统级的分布构建应用调用器，指定命令
	 * @param cmd 发布系统级的分布构建应用
	 */
	public WatchDeployEstablishPackageInvoker(DeployEstablishPackage cmd) {
		super(cmd);
	}
