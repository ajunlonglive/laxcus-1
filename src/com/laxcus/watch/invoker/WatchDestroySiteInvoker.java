 ...
 * @since laxcus 1.0
 */
public class WatchDestroySiteInvoker extends WatchCastElementInvoker {

	/**
	 * 构造销毁节点调用器，指定命令
	 * @param cmd 销毁节点
	 */
	public WatchDestroySiteInvoker(DestroySite cmd) {
		super(cmd);
	}
	...
	public boolean launch() {
		...
		// 删除节点运行时记录
		SiteRuntimeBasket.getInstance().dropRuntime(node);
