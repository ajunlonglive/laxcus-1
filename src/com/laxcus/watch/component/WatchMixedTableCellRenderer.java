 ...
 * @since laxcus 1.0
 */
public class WatchMixedTableCellRenderer extends DefaultTableCellRenderer {
	 ...
	 * 构造WATCH站点表格渲染器
	 */
	public WatchMixedTableCellRenderer() {
		super();
		init();
	}
	...
	public Component getTableCellRendererComponent(JTable table, Object value,
		...
		// 设置图标
		if (Laxkit.isClassFrom(value, ShowImageCell.class)) {
