 ...
 * @since laxcus 1.0
 */
public class WatchRegexDialog extends WatchCommonFontDialog implements ActionListener {
	 ...
	 */
	public WatchRegexDialog(Frame parent, boolean modal) throws HeadlessException {
		super(parent, modal);
	}
