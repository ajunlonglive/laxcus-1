 ...
 * @since laxcus 1.0
 */
public class WatchDeployCloudPackageDialog extends WatchCommonFontDialog implements ActionListener {

	private static final long serialVersionUID = 3202353334014037936L;

	/** 系统属性值 **/
	private final static String KEY_DEPLOY = "WATCH-DEPLOY-CLOUD-PACKAGE-PATH";
	
	private final static String KEY_BOUND = WatchDeployCloudPackageDialog.class.getSimpleName() + "_BOUND";
	 ...
	 */
	public WatchDeployCloudPackageDialog(Frame frame, boolean modal, int taskType) {
		super(frame, modal);
		family = taskType;
		accepted = false;
	}
