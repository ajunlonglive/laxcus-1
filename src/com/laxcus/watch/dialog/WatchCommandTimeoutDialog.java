 ...
 * @since laxcus 1.0
 */
public class WatchCommandTimeoutDialog extends WatchCommonFontDialog implements ActionListener {

	private static final long serialVersionUID = -8793114467956214947L;
	 ...
	 */
	public WatchCommandTimeoutDialog(Frame parent, boolean modal) {
		super(parent, modal);
	}
...
//	}
	...
	private void initControls() {
		...
		// 间隔时间
		long interval = WatchLauncher.getInstance().getCommandTimeout();
		// 取出时间下标
