 ...
 * @since laxcus 1.0
 */
public class RegisterMemberBasket extends SiteMemberBasket {

	/** 注册成员合集 **/
	private static RegisterMemberBasket selfHandle = new RegisterMemberBasket();
	 ...
	 * @return 注册成员合集实例
	 */
	public static RegisterMemberBasket getInstance() {
		return RegisterMemberBasket.selfHandle;
	}
