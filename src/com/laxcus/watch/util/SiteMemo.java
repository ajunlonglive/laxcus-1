 ...
 * @since laxcus 1.0
 */
public final class SiteMemo implements Classable, Cloneable, Serializable , Comparable<SiteMemo> {
	 ...
	 */
	private SiteMemo(SiteMemo that) {
		super();
		node = that.node;
	 ...
	 * @since 1.1
	 */
	public SiteMemo(ClassReader reader) {
		this();
		resolve(reader);
	}
	 ...
	 * @return SiteMemo实例副本
	 */
	public SiteMemo duplicate() {
		return new SiteMemo(this);
	}
	 ...
	 */
	@Override
	public int compareTo(SiteMemo that) {
		if (that == null) {
			return 1;
		}
