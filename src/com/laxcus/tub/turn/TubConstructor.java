 ...
 * @since laxcus 1.0
 */
public final class TubConstructor extends TubFormatter {
	 ...
	 */
	public TubConstructor(Object[] params) {
		this();
		this.params = params;
	}
	 ...
	 * @param param 实际参数值
	 */
	public TubConstructor(Object param) {
	 ...
	 */
	public TubConstructor(String interName, String methodName, Class<?>[] types, Object[] params) {
		this();
	 ...
	 * @param reader 可类化读取器
	 */
	public TubConstructor(ClassReader reader) {
		this();
		resolve(reader);
	}
	 ...
	 * @param len 有效数据长度
	 */
	public TubConstructor(byte[] b, int off, int len) {
	...
	public static byte[] build(Object param) {
		TubConstructor creator = new TubConstructor(param);
	...
	public static byte[] build(Object[] params) {
		TubConstructor apply = new TubConstructor(params);
		return apply.build();
	}
	 ...
	 * @param off 数据开始下标
	 * @param len 有效数据长度
	 * @return 返回TubCreator实例
	 */
	public static TubConstructor resolve(byte[] b, int off, int len) {
		return new TubConstructor(b, off, len);
	}
	 ...
	 * @return 返回TubCreator实例
	 */
	public static TubConstructor resolve(byte[] b) {
		return new TubConstructor(b, 0, b.length);
	}
