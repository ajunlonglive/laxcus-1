...
/**
 * 日志站点管理池。<br>
 * 监管HOME集群下的所有注册站点，包括CALL、DATA、WORK、BUILD。这些站点负责数据计算和存储工作。
 * 
 * @author scott.liang 
 * @version 1.1 4/22/2012
 * @since laxcus 1.0
 */
public final class LogOnHomePool extends HomePool {

	/** 静态句柄 **/
	private static LogOnHomePool selfHandle = new LogOnHomePool();
	 ...
	 * @return 日志站点管理池实例
	 */
	public static LogOnHomePool getInstance() {
		return LogOnHomePool.selfHandle;
	}
