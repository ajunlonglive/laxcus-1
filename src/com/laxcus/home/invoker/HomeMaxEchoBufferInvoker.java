 ...
 * @since laxcus 1.0
 */
public class HomeMaxEchoBufferInvoker extends HubMaxEchoBufferInvoker {

	/**
	 * 构造HOME站点异步缓存空间调用器，指定命令
	 * @param cmd 异步缓存空间命令
	 */
	public HomeMaxEchoBufferInvoker(MaxEchoBuffer cmd) {
		super(cmd);
	}

	/* (non-Javadoc)
	 * @see com.laxcus.echo.invoke.common.HubMaxEchoBufferInvoker#fetchSubSites()
	 */
	@Override
