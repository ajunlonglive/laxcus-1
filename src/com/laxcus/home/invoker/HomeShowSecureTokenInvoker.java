 ...
 * @since laxcus 1.0
 */
public class HomeShowSecureTokenInvoker extends HubShowSecureTokenInvoker {

	/**
	 * 构造读取密钥令牌调用器，指定命令
	 * @param cmd 读取密钥令牌
	 */
	public HomeShowSecureTokenInvoker(ShowSecureToken cmd) {
		super(cmd);
	}

	/*
	 * (non-Javadoc)
	 * @see com.laxcus.echo.invoke.common.HubShowSecureTokenInvoker#fetchSubSites()
	 */
	@Override
