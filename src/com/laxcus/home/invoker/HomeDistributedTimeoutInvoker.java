 ...
 * @since laxcus 1.0
 */
public class HomeDistributedTimeoutInvoker extends HubDistributedTimeoutInvoker {

	/**
	 * 构造HOME站点分布处理超时调用器，指定命令
	 * @param cmd 分布处理超时命令
	 */
	public HomeDistributedTimeoutInvoker(DistributedTimeout cmd) {
		super(cmd);
	}
