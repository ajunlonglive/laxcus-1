 ...
 * @since laxcus 1.0
 */
public class HomeSeekRegisterMetadataInvoker extends HomeInvoker {
	 ...
	 */
	public HomeSeekRegisterMetadataInvoker(SeekRegisterMetadata cmd) {
		super(cmd);
	}
