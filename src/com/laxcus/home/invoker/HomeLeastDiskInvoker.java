...
/**
 * HOME站点节点最小磁盘空间限制调用器。<br>
 * 
 * @author scott.liang
 * @version 1.0 8/19/2019
 * @since laxcus 1.0
 */
public class HomeLeastDiskInvoker extends HubLeastDiskInvoker {

	/**
	 * 构造HOME站点节点最小磁盘空间限制调用器，指定命令
	 * @param cmd 节点最小磁盘空间限制命令
	 */
	public HomeLeastDiskInvoker(LeastDisk cmd) {
		super(cmd);
	}

	/* (non-Javadoc)
	 * @see com.laxcus.echo.invoke.common.HubLeastDiskInvoker#fetchSubSites()
	 */
	@Override
