...
/**
 * HOME站点最大虚拟机内存使用率限制调用器。<br>
 * 
 * @author scott.liang
 * @version 1.0 1/21/2021
 * @since laxcus 1.0
 */
public class HomeMostVMMemoryInvoker extends HubMostVMMemoryInvoker {

	/**
	 * 构造HOME站点最大虚拟机内存使用率限制调用器，指定命令
	 * @param cmd 站点最大虚拟机内存使用率限制命令
	 */
	public HomeMostVMMemoryInvoker(MostVMMemory cmd) {
		super(cmd);
	}
