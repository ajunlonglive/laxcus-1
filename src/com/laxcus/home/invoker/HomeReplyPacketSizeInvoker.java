 ...
 * @since laxcus 1.0
 */
public class HomeReplyPacketSizeInvoker extends HubReplyPacketSizeInvoker {

	/**
	 * 构造设置应答包尺寸调用器，指定命令
	 * @param cmd 设置应答包尺寸
	 */
	public HomeReplyPacketSizeInvoker(ReplyPacketSize cmd) {
		super(cmd);
	}

	/*
	 * (non-Javadoc)
	 * @see com.laxcus.echo.invoke.common.HubReplyPacketSizeInvoker#fetchSubSites()
	 */
	@Override
...
//	/*
//	 * (non-Javadoc)
//	 * @see com.laxcus.echo.invoke.common.HubReplyPacketSizeInvoker#isBottomSite(byte)
//	 */
//	@Override
