 ...
 * @since laxcus 1.0
 */
public final class PatternExtractor extends PatternFormatter {
	 ...
	 * @param fatal 错误
	 */
	public PatternExtractor(Object object, Throwable fatal) {
		this();
		setObject(object);
		setThrowable(fatal);
	}
	 ...
	 * @param object 对象
	 */
	public PatternExtractor(Object object) {
		this(object, null);
	}
	 ...
	 * @param fatal 错误
	 */
	public PatternExtractor(Throwable fatal) {
		this(null, fatal);
	}
	 ...
	 */
	public PatternExtractor(ClassReader reader) {
		this();
		resolve(reader);
	}
	 ...
	 * @param len 长度
	 */
	public PatternExtractor(byte[] b, int off, int len) {
	...
	public String getThrowText() {
		return PatternExtractor.getMessage(fatal);
	}
	...
	public static byte[] build(Object object) throws IOException {
		PatternExtractor reply = new PatternExtractor(object);
		return reply.build();
	}
	 ...
	 * @param off 数据开始下标
	 * @param len 有效数据长度
	 * @return 返回PatternExtractor实例
	 */
	public static PatternExtractor resolve(byte[] b, int off, int len) {
		return new PatternExtractor(b, off, len);
	}
	 ...
	 * @return 返回PatternExtractor实例
	 */
	public static PatternExtractor resolve(byte[] b) {
		return new PatternExtractor(b, 0, b.length);
	}
