...
public class ToTaskException extends TaskException {
	...
	private static final long serialVersionUID = -8758119158228288L;
	...
	/**
	 * 在一个异常的基础上构造CONDUCT.TO阶段异常，指定提示信息和异常
	 * @param message 异常信息
	 * @param cause 另一个异常实例
	 */
