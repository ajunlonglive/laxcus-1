...
/**
 * DIFFUSE/CONVERGE分布计算的TO(CONVERGE)阶段任务的数据计算实例。<br><br>
 * 
 * 流程：<br>
 * <1> "evaluate"方法接受来自DATA/WORK节点的数据。<br>
 ...
 * @since laxcus 1.0
 */
public abstract class ToEvaluateTask extends ToTask {

	/**
	 * 构造TO阶段的数据计算实例
	 */
	protected ToEvaluateTask() {
		super(ToMode.EVALUATE);
	}
