 ...
 * @since laxcus 1.0
 */
public final class BootLibraryComponent implements Classable, Cloneable, Serializable, Comparable<BootLibraryComponent> { 
...
//		sock = null;
	 ...
	 */
	private BootLibraryComponent(BootLibraryComponent that) {
		this();
		ware = that.ware;
		name = that.name;
	 ...
	 * @param b 数据内容
	 */
	public BootLibraryComponent(Naming ware, String name, byte[] b) {
		this();
		setWare(ware);
		setName(name);
		setContent(b);
...
//	 * @param b 数据内容
//	 */
//	public BootLibraryComponent(BootPart part, MD5Hash sign, Naming ware, String name, byte[] b) {
...
//	}
	 ...
	 */
	public BootLibraryComponent(ClassReader reader) {
		this();
		resolve(reader);
	}
	 ...
	 * @param b 字节数组
	 */
	public BootLibraryComponent(byte[] b) {
...
//	}
	...
	/**
	 * 生成当前实例的一个数据副本
	 * @return BootLibraryComponent实例
	 */
	public BootLibraryComponent duplicate() {
		return new BootLibraryComponent(this);
	}
	...
	public boolean equals(Object that) {
		if (that == null || that.getClass() != BootLibraryComponent.class) {
			return false;
		} else if (that == this) {
			return true;
		}
		return compareTo((BootLibraryComponent) that) == 0;
	}
	 ...
	 */
	@Override
	public int compareTo(BootLibraryComponent that) {
		if (that == null) {
			return 1;
		}
