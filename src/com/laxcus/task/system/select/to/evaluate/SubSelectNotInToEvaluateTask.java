 ...
 * @since laxcus 1.0
 */
public class SubSelectNotInToEvaluateTask extends SQLToEvaluateTask {
	 ...
	 * 
	 */
	public SubSelectNotInToEvaluateTask() {
		super();
	}
	...
	private void createSheet() throws TaskException {
		...
		// 被检查表
		preselect = findSelect(SubSelectTaskKit.PRESELECT, session);
