 ...
 * @since laxcus 1.0
 */
//public final class Message implements Classable, Serializable, Cloneable, Comparable<Message> {
...
public final class Message implements Serializable, Cloneable, Comparable<Message> {
	 ...
	 * @since 1.1
	 */
	public Message(ClassReader reader) throws FixpProtocolException {
		this();
		resolve(reader);
	}
	 ...
	 * @throws IOException
	 */
	public int resolve(FixpInputStream input) throws IOException {
		// 读消息前缀部分
		...
		if (!MessageType.isType(family)) {
			throw new FixpProtocolException("illegal family: %d", family);
		}
		// 确定消息值长度和读取
	...
	public boolean isRaw() {
		return MessageType.isRaw(family);
	}
	...
	public boolean isString() {
		return MessageType.isString(family);
	}
	...
	public boolean isBoolean() {
		return MessageType.isBoolean(family);
	}
	...
	public boolean isShort() {
		return MessageType.isShort(family);
	}
	...
	public boolean isInteger() {
		return MessageType.isInteger(family);
	}
	...
	public boolean isLong() {
		return MessageType.isLong(family);
	}
	...
	public boolean isFloat() {
		return MessageType.isFloat(family);
	}
	...
	public boolean isDouble() {
		return MessageType.isDouble(family);
	}
	...
	public void setRaw(byte[] value) {
		...
		setValue(MessageType.RAW, value, 0, value.length);
	}
	...
	public void setValue(boolean value) {
		byte[] b = new byte[1];
		b[0] = (byte) (value ? 1 : 0);
		setValue(MessageType.BOOLEAN, b, 0, b.length);
	}
	...
	public void setValue(short value) {
		...
		setValue(MessageType.INT16, b, 0, b.length);
	}
	...
	public void setValue(int value) {
		byte[] b = Laxkit.toBytes(value, true);
		setValue(MessageType.INT32, b, 0,b.length);
	}
	...
	public void setValue(long value) {
		byte[] b = Laxkit.toBytes(value, true);
		setValue(MessageType.INT64, b, 0, b.length);
	}
	...
	public void setValue(String value) {
		...
		try {
			...
			setValue(MessageType.STRING, b, 0, b.length);
	...
	public void setValue(float value) {
		...
		setValue(MessageType.REAL32, b,0, b.length);
	}
	...
	public void setValue(double value) {
		...
		byte[] b = Laxkit.toBytes(num, true);
		setValue(MessageType.REAL64, b,0, b.length);
	}
	...
	public boolean equals(Object that) {
		if (that == null || that.getClass() != Message.class) {
			return false;
		} else if (that == this) {
			return true;
		}
		return compareTo((Message) that) == 0;
	}
...
//	@Override
	...
	public int resolve(ClassReader reader) throws IndexOutOfBoundsException, FixpProtocolException {
	 ...
	 * @return 返回解析长度
	 */
	public int resolve(byte[] b, int off, int len) throws IndexOutOfBoundsException, FixpProtocolException {
