 ...
 * @since laxcus 1.0
 */
public class VideoSlider extends VariableSlider {
	...
	public boolean isSupport(Object e) {
		return (e.getClass() == com.laxcus.access.column.Video.class);
	}
	...
	public java.lang.Number seek(Object e) throws SliderException {
		...
		return super.doDefaultSeek((com.laxcus.access.column.Video) e);
	}
