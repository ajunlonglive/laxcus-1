 ...
 * @since laxcus 1.0
 */
public class FloatSlider extends ColumnSlider {
	...
	public boolean isSupport(Object e) {
		return (e.getClass() == com.laxcus.access.column.Float.class);
	}
	...
	public java.lang.Number seek(Object e) throws SliderException {
		...
		com.laxcus.access.column.Float column = (com.laxcus.access.column.Float) e;
		if (column.isNull()) {
			return new java.lang.Float(0);
		}
		return new java.lang.Float(column.getValue());
	}
