 ...
 * @since laxcus 1.0
 */
public class IntegerSlider extends ColumnSlider {
	...
	public boolean isSupport(Object e) {
		return (e.getClass() == com.laxcus.access.column.Integer.class);
	}
	...
	public java.lang.Number seek(Object e) throws SliderException {
		...
		com.laxcus.access.column.Integer column = (com.laxcus.access.column.Integer)e;
		if (column.isNull()) {
