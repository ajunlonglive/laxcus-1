 ...
 * @since laxcus 1.0
 */
public final class ForkObject extends AccessObject {

	private static final long serialVersionUID = 4986137596608887107L;

	/**
	 * 根据传入参数，生成INIT阶段命名的副本
	 * @param that ForkObject实例
	 */
	private ForkObject(ForkObject that) {
		super(that);
	}
	 ...
	 * @since 1.1
	 */
	public ForkObject(ClassReader reader) {
		this();
		resolve(reader);
	}
	 ...
	 */
	@Override
	public ForkObject duplicate() {
		return new ForkObject(this);
	}
