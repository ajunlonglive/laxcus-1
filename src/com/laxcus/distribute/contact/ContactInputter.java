 ...
 * @since laxcus 1.0
 */
public abstract class ContactInputter extends AccessObject {

	private static final long serialVersionUID = 4527711971537630223L;

	/** 指定的WORK节点数，默认是0不指定。此参数可以操作界面中定义 **/
	private int sites;
	
	/**
	 * 构造一个默认的输入对象
	 */
	protected ContactInputter() {
		super();
		sites = 0;
	}
	...
	/**
	 * 根据传入的输入对象，生成它的副本
	 * @param that ContactInputter实例
	 */
	protected ContactInputter(ContactInputter that) {
		super(that);
		sites = that.sites;
	}
