 ...
 * @since laxcus 1.0
 */
public final class TaskTime extends TaskParameter {
	 ...
	 * @param that
	 */
	private TaskTime(TaskTime that) {
		super(that);
		value = that.value;
	}
	 ...
	 * @param value 参数值
	 */
	public TaskTime(String title, int value) {
		this();
		setName(title);
		setValue(value);
	}
	 ...
	 * @param value 参数值
	 */
	public TaskTime(Naming title, int value) {
		this();
		setName(title);
		setValue(value);
	}
	 ...
	 * @since 1.1
	 */
	public TaskTime(ClassReader reader) {
		this();
		resolve(reader);
	}
